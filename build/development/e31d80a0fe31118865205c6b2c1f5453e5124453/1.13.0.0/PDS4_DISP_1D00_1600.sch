<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:disp  Version:1.6.0.0 - Wed Apr 27 06:05:43 UTC 2022 -->
  ...
  <sch:pattern>
    <sch:rule context="disp:Color_Display_Settings">
      ...
      <sch:assert test="//pds:*[pds:local_identifier=$local_identifier_reference]/pds:Axis_Array[pds:axis_name=$color_display_axis]">
        ...
        The color display axis (<sch:value-of select='$color_display_axis'/>) in color display settings must match the name of an axis in the referenced Array (<sch:value-of select='$local_identifier_reference'/>)</sch:assert>
      <sch:assert test="not($color_display_axis=($horizontal_display_axis, $vertical_display_axis))">
        <title>color_settings_validate_axis/Rule</title>
        The color display axis (<sch:value-of select='$color_display_axis'/>) must not match the name of the horizontal or vertical axes in the referenced Array (<sch:value-of select='$local_identifier_reference'/>)</sch:assert>
      <sch:assert test="not(number(disp:red_channel_band) > $bands)">
        <title>color_settings_validate_axis/Rule</title>
        The value of disp:red_channel_band (<sch:value-of select="disp:red_channel_band"/>) is out of range for the length (<sch:value-of select='$bands'/>) of the color display axis (<sch:value-of select='$color_display_axis'/>).</sch:assert>
      <sch:assert test="not(number(disp:green_channel_band) > $bands)">
        <title>color_settings_validate_axis/Rule</title>
        The value of disp:green_channel_band (<sch:value-of select="disp:green_channel_band"/>) is out of range for the length (<sch:value-of select='$bands'/>) of the color display axis (<sch:value-of select='$color_display_axis'/>).</sch:assert>
      <sch:assert test="not(number(disp:blue_channel_band) > $bands)">
        <title>color_settings_validate_axis/Rule</title>
        The value of disp:blue_channel_band (<sch:value-of select="disp:blue_channel_band"/>) is out of range for the length (<sch:value-of select='$bands'/>) of the color display axis (<sch:value-of select='$color_display_axis'/>).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="disp:Display_Settings">
      ...
      <sch:assert test="not($horizontal_display_axis=$vertical_display_axis)">
        <title>display_settings_validate_axis/Rule</title>
        The horizontal display axis (<sch:value-of select='$horizontal_display_axis'/>) must not match the name of the vertical axis in the referenced Array (<sch:value-of select='$local_identifier_reference'/>)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="disp:Movie_Display_Settings">
      ...
      <sch:assert test="//pds:*[pds:local_identifier=$local_identifier_reference]/pds:Axis_Array[pds:axis_name=$time_display_axis]">
        ...
        The time display axis (<sch:value-of select='$time_display_axis'/>) in movie display settings must match the name of an axis in the referenced Array (<sch:value-of select='$local_identifier_reference'/>)</sch:assert>
      <sch:assert test="not($time_display_axis=($horizontal_display_axis, $vertical_display_axis))">
        <title>movie_settings_validate_axis/Rule</title>
        The time display axis (<sch:value-of select='$time_display_axis'/>) must not match the name of the horizontal or vertical axes in the referenced Array (<sch:value-of select='$local_identifier_reference'/>)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
